package rocks.zipcode.quiz7.arrays.squarearrayanalyzer;

import org.junit.Assert;
import org.junit.Test;
import rocks.zipcode.quiz7.arrays.SquareArrayAnalyzer;
...
public class CompareAssortedArrays {
    ...
    private void test(Integer[] array1, Integer[] array2) {
        ...
        array1 = intList1.toArray(new Integer[0]);
        array2 = intList2.toArray(new Integer[0]);
